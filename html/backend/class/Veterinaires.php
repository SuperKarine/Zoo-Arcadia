...
class Veterinaire
{
    ...
    private $_date;
    private $_heure;
    private $_etatHabitat;
    private $_statutConnexion;
    

    private function __construct($_nom,$_prenom, $_username, $_password, $_mail, $_role, $_nourriture, $_quantiteNourriture, $_animal, $_date, $_heure, $_etatHabitat, $_statutConnexion) { 
        $this->_nom = $_nom;
        ...
        $this->_date= $_date;
        $this->_heure= $_heure;
        $this->$_etatHabitat= $_etatHabitat;
